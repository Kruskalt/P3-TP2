...
public class testKruskalBFS {
	...
	public void testMinimo() {
		...
		assertEquals(z, Kruskal.arbolGeneradorMinimoBFS(f));
	}
	...
	public void testNotMinimo() {
		...
		assertNotEquals(z, Kruskal.arbolGeneradorMinimoBFS(f));
	}
	...
	public void testGrafoGeneradorMinimo() {
		...
		assertTrue(Kruskal.arbolGeneradorMinimoBFS(h).existeArista(0, 1));
		assertTrue(Kruskal.arbolGeneradorMinimoBFS(h).existeArista(1, 2));
		assertFalse(Kruskal.arbolGeneradorMinimoBFS(h).existeArista(0, 2));
	}
	...
	public void testGrafoGeneradorMinimo3() {
		...
		assertEquals(j, Kruskal.arbolGeneradorMinimoBFS(j));
	}
	
	@Test (expected = IllegalArgumentException.class)
	public void testGrafoSinVertices() {
		assertEquals(g,Kruskal.arbolGeneradorMinimoBFS(g));
	}
